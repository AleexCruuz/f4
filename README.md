<p align="center">
  <picture>
    ...
    <img src="docs/assets/readme/logo.svg" width="220" alt="F4 logo">
  </picture>
</p>

<h1 align="center">F4</h1>
...
<p align="center">
  <a href="https://aleexcruuz.github.io/f4/">Website</a> ·
...
<p align="center">
  <a href="https://github.com/AleexCruuz/f4/releases"><img src="https://img.shields.io/github/v/release/AleexCruuz/f4?label=release&color=4c8dff" alt="Latest release"></a>
  <a href="https://github.com/AleexCruuz/f4/releases"><img src="https://img.shields.io/github/downloads/AleexCruuz/f4/total?color=4c8dff" alt="Downloads"></a>
  <a href="https://github.com/AleexCruuz/f4/actions/workflows/ci.yml"><img src="https://github.com/AleexCruuz/f4/actions/workflows/ci.yml/badge.svg?event=push" alt="CI status"></a>
...
Nobody needs all of it, and F4 is built around that. The Features page installs and uninstalls whole features: what you uninstall disappears from the entire app and stops loading, so it spends no CPU, memory or energy. Nothing is deleted, and installing again brings your old settings back.
...
- **Bluetooth on sleep.** Switches Bluetooth off while the Mac sleeps, so a laptop in a bag stops stealing the headphones you are listening to elsewhere. Bluetooth you had already turned off stays off, and only what F4 switched off comes back on wake.

## Install

Grab `F4.dmg` from the [releases page](https://github.com/AleexCruuz/f4/releases) and drag F4 into Applications.

Builds are not notarized yet, so macOS blocks the first launch: open System Settings › Privacy & Security and choose **Open Anyway**.
...
```sh
brew uninstall --cask f4
```

To remove F4 completely, including its settings and permissions:
...
```sh
git clone https://github.com/AleexCruuz/f4.git
cd f4
...
Xcode Command Line Tools are the only requirement. The [contributing guide](CONTRIBUTING.md) covers the layout and conventions. Official builds come only from the maintainer: the GPL covers the source, while the F4 name, icon and look are covered by [TRADEMARKS.md](TRADEMARKS.md), so forks need their own identity.

## When something misbehaves

The [troubleshooting guide](docs/TROUBLESHOOTING.md) walks through the common cases: the app blocked on first launch, a permission that will not stick, thumbnails showing as icons. To remove F4 completely, `./Tools/uninstall.sh` quits the app, drops the login item, resets its privacy grants and deletes every trace.
...
F4 is free and will stay that way. If it earned its place in your menu bar, a star helps other people find it.

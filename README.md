<p align="center">
  <picture>
    ...
    <img src="docs/assets/readme/logo.svg" width="220" alt="AltF4 logo">
  </picture>
</p>

<h1 align="center">AltF4</h1>
...
<p align="center">
  <a href="https://altf4.com">Website</a> ·
  <a href="#install">Install</a> ·
  <a href="#everything-it-does">Features</a> ·
  <a href="#private-by-default">Privacy</a> ·
  <a href="CHANGELOG.md">Changelog</a> ·
  <a href="mailto:hello@altf4.com">Contact</a> ·
  <a href="https://buymeacoffee.com/altf4">Buy Me a Coffee</a>
</p>

<p align="center">
  <a href="https://github.com/altf4/altf4-utils/releases"><img src="https://img.shields.io/github/v/release/altf4/altf4-utils?label=release&color=4c8dff" alt="Latest release"></a>
  <a href="https://github.com/altf4/altf4-utils/releases"><img src="https://img.shields.io/github/downloads/altf4/altf4-utils/total?color=4c8dff" alt="Downloads"></a>
  <a href="https://github.com/altf4/altf4-utils/actions/workflows/ci.yml"><img src="https://github.com/altf4/altf4-utils/actions/workflows/ci.yml/badge.svg?branch=main&event=push" alt="CI status"></a>
...
<p align="center">
  ...
  <a href="mailto:hello@altf4.com"><strong>hello@altf4.com</strong></a>.
</p>

<p align="center">
  <a href="https://trendshift.io/repositories/53716?utm_source=repository-badge&amp;utm_medium=badge&amp;utm_campaign=badge-repository-53716" target="_blank" rel="noopener noreferrer"><img src="https://trendshift.io/api/badge/repositories/53716" alt="altf4/altf4-utils | Trendshift" width="250" height="55"></a>
  <a href="https://trendshift.io/repositories/53716?utm_source=trendshift-badge&amp;utm_medium=badge&amp;utm_campaign=badge-trendshift-53716" target="_blank" rel="noopener noreferrer"><img src="https://trendshift.io/api/badge/trendshift/repositories/53716/weekly?language=Swift" alt="altf4/altf4-utils | Trendshift weekly ranking" width="250" height="55"></a>
</p>
...
Nobody needs all of it, and AltF4 is built around that. The Features page installs and uninstalls whole features: what you uninstall disappears from the entire app and stops loading, so it spends no CPU, memory or energy. Nothing is deleted, and installing again brings your old settings back.
...
- **Bluetooth on sleep.** Switches Bluetooth off while the Mac sleeps, so a laptop in a bag stops stealing the headphones you are listening to elsewhere. Bluetooth you had already turned off stays off, and only what AltF4 switched off comes back on wake.
...
```sh
brew install --cask altf4
```

Or grab the disk image from the [releases page](https://github.com/altf4/altf4-utils/releases) and drag AltF4 into Applications.
...
```sh
brew uninstall --cask altf4
```

To remove AltF4 completely, including its settings and permissions:
...
```sh
git clone https://github.com/altf4/altf4-utils.git
cd altf4-utils
...
Xcode Command Line Tools are the only requirement. The [contributing guide](CONTRIBUTING.md) covers the layout and conventions. Official builds come only from the maintainer: the GPL covers the source, while the AltF4 name, icon and look are covered by [TRADEMARKS.md](TRADEMARKS.md), so forks need their own identity.

## When something misbehaves

The [troubleshooting guide](docs/TROUBLESHOOTING.md) walks through the common cases: the app blocked on first launch, a permission that will not stick, thumbnails showing as icons. To remove AltF4 completely, `./Tools/uninstall.sh` quits the app, drops the login item, resets its privacy grants and deletes every trace.
...
AltF4 went from first commit to the front of GitHub trending in three days, top of the Swift charts, and issues and pull requests have shaped every release since. Bug reports, feature ideas and translations are all welcome, starting from the [contributing guide](CONTRIBUTING.md).

AltF4 is free and will stay that way. If it earned its place in your menu bar, a star helps other people find it, and a [coffee](https://buymeacoffee.com/altf4) keeps the maintainer awake, with or without the Keep awake feature.
...
[GPL 3.0 or later](LICENSE), copyright 2026 AltF4. The license covers the source code; the AltF4 name, logo and look are covered separately in [TRADEMARKS.md](TRADEMARKS.md).

<p align="center">
  <sub>Made by <a href="https://x.com/altf4">@altf4</a></sub>
</p>

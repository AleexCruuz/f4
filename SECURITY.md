...
Thanks for helping keep F4 and the people who use it safe.
...
- **[Report a vulnerability privately](https://github.com/AleexCruuz/f4/security/advisories/new)**
...
- The F4 version from Settings under About and your macOS version.
...
F4 runs locally and ships as a signed and notarized macOS app. The reports that matter most are the ones that could affect the integrity of the app or its self update flow, or that could let the app's permissions be misused. Issues in the outside services the app merely talks to, like GitHub's releases API or the speed test endpoint, are best taken to those providers.

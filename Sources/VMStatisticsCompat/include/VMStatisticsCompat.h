...
#ifndef F4_VM_STATISTICS_COMPAT_H
#define F4_VM_STATISTICS_COMPAT_H
...
} __attribute__((aligned(8))) f4_vm_statistics64_rev3_t;

enum {
    F4_HOST_VM_INFO64_REV1_COUNT =
        offsetof(f4_vm_statistics64_rev3_t, swapped_count) / sizeof(integer_t),
    F4_HOST_VM_INFO64_REV2_COUNT =
        offsetof(f4_vm_statistics64_rev3_t, total_tag_storage_pages) / sizeof(integer_t),
    F4_HOST_VM_INFO64_REV3_COUNT =
        sizeof(f4_vm_statistics64_rev3_t) / sizeof(integer_t),
};

_Static_assert(sizeof(integer_t) == 4, "HOST_VM_INFO64 counts must use 32-bit integer_t words");
_Static_assert(_Alignof(f4_vm_statistics64_rev3_t) == 8,
               "vm_statistics64 rev3 must remain 64-bit aligned");
_Static_assert(sizeof(f4_vm_statistics64_rev3_t) == 248,
               "unexpected HOST_VM_INFO64 rev3 size");
_Static_assert(offsetof(f4_vm_statistics64_rev3_t, total_tag_storage_pages) == 160,
...
_Static_assert(offsetof(f4_vm_statistics64_rev3_t, swapped_count) ==
                   offsetof(vm_statistics64_data_t, swapped_count),
               "swapped_count layout mismatch with the active SDK");
_Static_assert(F4_HOST_VM_INFO64_REV2_COUNT == HOST_VM_INFO64_REV2_COUNT,
               "HOST_VM_INFO64 rev2 count mismatch with the active SDK");
#endif

#ifdef HOST_VM_INFO64_REV3_COUNT
_Static_assert(F4_HOST_VM_INFO64_REV3_COUNT == HOST_VM_INFO64_REV3_COUNT,
               "HOST_VM_INFO64 rev3 count mismatch with the active SDK");
_Static_assert(offsetof(f4_vm_statistics64_rev3_t, total_tag_storage_pages) ==
...
f4_read_vm_statistics64(f4_vm_statistics64_rev3_t *statistics,
    ...
    *returned_count = F4_HOST_VM_INFO64_REV3_COUNT;

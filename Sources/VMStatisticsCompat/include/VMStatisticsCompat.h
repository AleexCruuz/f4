...
#ifndef ALTF4_VM_STATISTICS_COMPAT_H
#define ALTF4_VM_STATISTICS_COMPAT_H
...
} __attribute__((aligned(8))) altf4_vm_statistics64_rev3_t;

enum {
    ALTF4_HOST_VM_INFO64_REV1_COUNT =
        offsetof(altf4_vm_statistics64_rev3_t, swapped_count) / sizeof(integer_t),
    ALTF4_HOST_VM_INFO64_REV2_COUNT =
        offsetof(altf4_vm_statistics64_rev3_t, total_tag_storage_pages) / sizeof(integer_t),
    ALTF4_HOST_VM_INFO64_REV3_COUNT =
        sizeof(altf4_vm_statistics64_rev3_t) / sizeof(integer_t),
};

_Static_assert(sizeof(integer_t) == 4, "HOST_VM_INFO64 counts must use 32-bit integer_t words");
_Static_assert(_Alignof(altf4_vm_statistics64_rev3_t) == 8,
               "vm_statistics64 rev3 must remain 64-bit aligned");
_Static_assert(sizeof(altf4_vm_statistics64_rev3_t) == 248,
               "unexpected HOST_VM_INFO64 rev3 size");
_Static_assert(offsetof(altf4_vm_statistics64_rev3_t, total_tag_storage_pages) == 160,
...
_Static_assert(offsetof(altf4_vm_statistics64_rev3_t, swapped_count) ==
                   offsetof(vm_statistics64_data_t, swapped_count),
               "swapped_count layout mismatch with the active SDK");
_Static_assert(ALTF4_HOST_VM_INFO64_REV2_COUNT == HOST_VM_INFO64_REV2_COUNT,
               "HOST_VM_INFO64 rev2 count mismatch with the active SDK");
#endif

#ifdef HOST_VM_INFO64_REV3_COUNT
_Static_assert(ALTF4_HOST_VM_INFO64_REV3_COUNT == HOST_VM_INFO64_REV3_COUNT,
               "HOST_VM_INFO64 rev3 count mismatch with the active SDK");
_Static_assert(offsetof(altf4_vm_statistics64_rev3_t, total_tag_storage_pages) ==
...
altf4_read_vm_statistics64(altf4_vm_statistics64_rev3_t *statistics,
    ...
    *returned_count = ALTF4_HOST_VM_INFO64_REV3_COUNT;

...
enum UpdateShowcaseInfo {
    ...
    static let mediaAssetName = "f4-3.1.4-showcase-1.mp4"
    static let mediaSHA256 = "88031b2b48708b8eb96248fef1143432a0600382b59ad5ea39e0746af27ab9e8"

    static var remoteMediaURL: URL {
        URL(string: "https://github.com/AleexCruuz/f4/releases/download/v\(releaseVersion)/\(mediaAssetName)")!
    }
    ...
    static var localDeveloperMediaURL: URL? {
        ...
        let desktopDemo = URL(fileURLWithPath: "/Users/f4/Desktop/demo.gif")
    ...
    static var cacheDirectory: URL {
        ...
        let bundleID = Bundle.main.bundleIdentifier ?? "com.f4.utils"
        return base

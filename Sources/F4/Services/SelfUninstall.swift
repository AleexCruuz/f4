...
enum SelfUninstall {
    private static var bundleID: String { Bundle.main.bundleIdentifier ?? "com.f4.utils" }
    ...
    /// bundle to the Trash and quits. Used by "Uninstall F4 completely".
    ...
    private static func trashOwnBundleAndQuit() {
        ...
        let scriptURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("f4-uninstall-\(pid)-\(UUID().uuidString).sh")
        do {

...
/// activation this app holds, and F4 (`LSUIElement`, non-activating
...
enum ActivationHandoff {
    ...
    /// Past that, an activation of F4 is the user opening one of its
    ...
    /// Whether the activation of F4 being reported right now is the one

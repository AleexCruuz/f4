...
final class ShelfService: ObservableObject {
    ...
    private let tempDir: URL = {
        let id = Bundle.main.bundleIdentifier ?? "com.f4.utils"
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("F4Shelf", isDirectory: true)
    ...
    private static let persistQueue = DispatchQueue(label: "com.f4.utils.shelf-persist",
                                                    qos: .utility)

...
final class ScreenshotService: ObservableObject {
    ...
    private var hideF4Windows: Bool {
        UserDefaults.standard.bool(forKey: DefaultsKey.screenshotHideF4Windows)
    }
    ...
    /// Ordinary windows somebody left on screen, which the "Hide F4
...
enum ScreenshotLastCaptureStore {
    private static let writeQueue = DispatchQueue(
        label: "com.f4.utils.latest-screenshot",
        qos: .utility)

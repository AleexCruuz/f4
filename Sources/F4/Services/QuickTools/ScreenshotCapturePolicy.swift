...
enum ScreenshotCapturePolicy {
    ...
    /// F4 windows" preference narrows what is left.
    ///
    ...
    static func excludedWindowIDs(hideF4Windows: Bool,
                                  ownWindowIDs: Set<CGWindowID>,
                                  protectedWindowIDs: Set<CGWindowID>) -> Set<CGWindowID> {
        hideF4Windows ? ownWindowIDs : ownWindowIDs.intersection(protectedWindowIDs)
    }
    ...
    static func canPickWindow(_ windowID: CGWindowID,
        ...
        !isOwnWindow
            || (!hideF4Windows && !protectedWindowIDs.contains(windowID))
    }

...
private final class NotchAudioLevelReader {
    private let queue = DispatchQueue(label: "com.f4.notch-audio-levels", qos: .utility)
    private static let teardownQueue = DispatchQueue(label: "com.f4.notch-audio-levels.teardown", qos: .utility)
    ...
    private func buildTap() -> Bool {
        ...
        description.name = "F4 Island Levels"
    ...
    private func buildPipeline() -> Bool {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "F4 Island Levels",

...
final class RecorderSystemAudioTap: @unchecked Sendable {
    ...
    private static let teardownQueue = DispatchQueue(label: "com.f4.recorder.systemaudio.teardown",
                                                     qos: .utility)
    ...
    static func make() async -> RecorderSystemAudioTap? {
        ...
        let queue = DispatchQueue(label: "com.f4.recorder.systemaudio",
                                  qos: .userInitiated)
    ...
    private func buildPipeline() {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "F4 Recorder",

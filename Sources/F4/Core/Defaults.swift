...
enum DefaultsKey {
    ...
    // Set only while F4 owes a Bluetooth restore, so a Mac shut down
    ...
    static let screenshotHideF4Windows = "screenshotHideF4Windows"
...
enum KeepAwakeActiveIcon: String, CaseIterable, Identifiable {
    ...
    var menuBarDrop: CGFloat {
        ...
        case .f4, .eye, .moon: return 0
        }
    }

    func title(_ strings: Strings) -> String {
        switch self {
        case .f4: return strings.keepAwakeActiveIconF4
...
enum Defaults {
    ...
    static let registeredDefaults: [String: Any] = [
        ...
        DefaultsKey.keepAwakeActiveIcon: KeepAwakeActiveIcon.f4.rawValue,
        ...
        DefaultsKey.screenshotHideF4Windows: true,

...
struct Strings {
    ...
    let keepAwakeActiveIconF4: String
...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "F4: suspensão normal",
        statusActiveUntil: "F4: ativo até",
        statusActiveIndefinite: "F4: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o F4",
        menuQuit: "Sair do F4",
        menuHide: "Ocultar o F4",
        ...
        notifyBatteryTitle: "F4 desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O F4 precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O F4 precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O F4 foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O F4 precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O F4 vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O F4 vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do F4",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao F4 (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o F4 para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o F4 completamente",
        advancedUninstallConfirmTitle: "Desinstalar o F4?",
        advancedUninstallConfirmBody: "O F4 vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        advancedUninstallFailedTitle: "A desinstalação parou",
        advancedUninstallFailedBody: "O F4 não conseguiu restaurar uma configuração do sistema que ele mudou: repouso, velocidade das ventoinhas ou aceleração do mouse. Nada foi removido. Tente de novo e permita o pedido de senha, se ele aparecer.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o F4",
        ...
        switcherEnable: "Usar o alternador do F4",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desativa os atalhos correspondentes de apps e janelas do macOS somente enquanto o alternador do F4 estiver ativo. Todos os apps abertos continuam acessíveis.",
        ...
        uninstallerFDAHint: "Ative o F4 na lista. Se ele não aparecer, clique no + e escolha o F4 em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O F4 pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O F4 pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O F4 não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do F4",
        ...
        updateNeedsApplicationsTitle: "Mova o F4 para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o F4 para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        secureInputHeldFormat: "%@ está mantendo-a ativa, então o F4 não consegue digitar por você. Saia do campo de senha do app, ou encerre-o, para liberá-la.",
        secureInputUnattributed: "Nenhum app em execução a reivindica. Encerre a sessão e entre novamente para limpá-la.",
        secureInputUnidentified: "Não foi possível identificar o app que a está mantendo ativa, então o F4 não consegue digitar por você.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o F4 precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o F4 a continuar crescendo",
        donateMessage: "O F4 é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no Buy Me a Coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o F4 a continuar crescendo",
        ...
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o F4 e faz uma diferença enorme no desenvolvimento.",
        supportIntroCoffeeButton: "Apoiar no Buy Me a Coffee",
        supportIntroLaterButton: "Agora não",
        supportIntroDoneButton: "Concluir",
        discordIntroTitle: "A comunidade do F4 no Discord está começando",
        discordIntroMessage: "A comunidade do F4 é nova e ainda está em desenvolvimento. Entre desde o começo para conhecer outros usuários e ajudar a construir um espaço acolhedor em torno do app.",
        ...
        communityIntroFollowButton: "Seguir @f4 no X",
        homebrewOfficialIntroTitle: "Agora no catálogo oficial do Homebrew",
        homebrewOfficialIntroMessage: "O F4 agora pode ser instalado direto do catálogo oficial do Homebrew.",
        ...
        showMenuBarIconCaption: "Se o ícone do F4 sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o F4 pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o F4 lá, ou configure o %@ para sempre mostrar o F4.",
        ...
        cleanerNotifDenied: "As notificações do F4 estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o F4 para a pasta Aplicativos, abra de lá e ligue de novo.",
        launchAtLoginNeedsApproval: "O item de login está registrado, mas continua desligado nos Ajustes do Sistema. Abra Ajustes do Sistema › Geral › Itens de Início e Extensões e ligue o F4 em “Abrir ao iniciar sessão”.",
        ...
        mouseAccelerationCaption: "Remove a aceleração do cursor para os mouses conectados. A configuração anterior volta ao desligar esta opção ou sair do F4.",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "F4: normal sleep",
        statusActiveUntil: "F4: awake until",
        statusActiveIndefinite: "F4: awake indefinitely",
        ...
        notifyBatteryTitle: "F4 disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "F4 needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "F4 needs your password to restore the Mac’s normal sleep.",
        adminPromptRecover: "F4 quit while the Mac’s sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "F4 needs your password to install the update.",
        adminPromptSudoersInstall: "F4 will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "F4 will remove the password-free closed-lid rule.",

        settingsTitle: "F4 Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted F4 (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves F4 to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall F4 completely",
        advancedUninstallConfirmTitle: "Uninstall F4?",
        advancedUninstallConfirmBody: "F4 will clear its permissions, remove its preferences and move to the Trash, then quit. This can’t be undone from the app, but it stays in the Trash until you empty it.",
        advancedUninstallFailedTitle: "Uninstall stopped",
        advancedUninstallFailedBody: "F4 could not put back a system setting it changed: sleep, fan speed or mouse acceleration. Nothing was removed. Try again and allow the password request if it appears.",
        ...
        keepAwakeAutoStart: "Keep Awake when F4 opens",
        ...
        switcherEnable: "Use the F4 switcher",
        ...
        switcherTakeOverSystemShortcutsCaption: "Disables the matching macOS app and window shortcuts only while F4’s switcher is active. All running apps stay reachable.",
        ...
        uninstallerFDAHint: "Turn F4 on in the list. If it isn’t there, click + and pick F4 from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "F4 can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. F4 can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. F4 does not capture passwords.",
        ...
        updateNeedsApplicationsTitle: "Move F4 to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag F4 to the Applications folder, open it from there and try again.",
        ...
        secureInputHeldFormat: "%@ is holding it, so F4 cannot type for you. Dismiss its password field, or quit it, to release it.",
        secureInputUnattributed: "No running app claims it. Log out and back in to clear it.",
        secureInputUnidentified: "The app holding it could not be identified, so F4 cannot type for you.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, F4 needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help F4 keep growing",
        donateMessage: "F4 is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help F4 keep growing",
        supportIntroMessage: "If you would like to support development financially, Buy Me a Coffee is the one place to do it.",
        supportIntroStarButton: "Star F4 on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover F4 and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The F4 Discord community is just getting started",
        discordIntroMessage: "The F4 community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        communityIntroFollowButton: "Follow @f4 on X",
        homebrewOfficialIntroTitle: "Now in the official Homebrew catalog",
        homebrewOfficialIntroMessage: "F4 can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If F4’s icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen F4 from Applications or Spotlight: that rebuilds the icon and, if it’s still hidden, opens this window.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for F4 there, or set %@ to always show F4.",
        ...
        cleanerNotifDenied: "F4 notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag F4 to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn F4 on under Open at Login.",
        ...
        mouseAccelerationCaption: "Removes pointer acceleration for connected mice. Your previous setting returns when this is turned off or F4 quits.",

...
extension BluetoothSleepStrings {
    static let enUS = BluetoothSleepStrings(
        ...
        restoreCaption: "Only when F4 was the one that switched it off.",
    ...
    static let ptBR = BluetoothSleepStrings(
        ...
        restoreCaption: "Apenas quando foi o F4 que o desligou.",
    ...
    static let tr = BluetoothSleepStrings(
        ...
        restoreCaption: "Yalnızca kapatan F4 olduğunda.",
    ...
    static let ru = BluetoothSleepStrings(
        ...
        restoreCaption: "Только если его выключил сам F4.",
    ...
    static let es = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo cuando fue F4 quien lo apagó.",
    ...
    static let de = BluetoothSleepStrings(
        ...
        restoreCaption: "Nur wenn F4 es ausgeschaltet hat.",
    ...
    static let fr = BluetoothSleepStrings(
        ...
        restoreCaption: "Uniquement si c’est F4 qui l’a coupé.",
    ...
    static let it = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo quando è stato F4 a spegnerlo.",
    ...
    static let ko = BluetoothSleepStrings(
        ...
        restoreCaption: "F4가 껐을 때만 다시 켭니다.",

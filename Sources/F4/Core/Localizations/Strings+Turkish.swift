...
extension Strings {
    static let tr = Strings(
        statusIdleTooltip: "F4: normal uyku",
        statusActiveUntil: "F4: şu zamana kadar uyanık",
        statusActiveIndefinite: "F4: süresiz uyanık",
        ...
        notifyBatteryTitle: "F4 devre dışı",
        notifyBatteryBody: "Pil düşük. Şarjı korumak için normal uyku geri yüklendi.",
        adminPromptClamshellOn: "F4’in, Mac’i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "F4’in, Mac’in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        adminPromptRecover: "Mac’in uykusu kapalıyken F4 kapandı. Normal uykuyu geri yüklemek için parolayı gir.",
        adminPromptUpdate: "F4 güncellemeyi yüklemek için parolanıza ihtiyaç duyuyor.",
        adminPromptSudoersInstall: "F4, parola sormadan kapak kapalı modunu açıp kapatmak için kısıtlı bir kural oluşturacak (yalnızca pmset disablesleep). Parolanın gerektiği tek zaman bu.",
        adminPromptSudoersRemove: "F4, parolasız kapak kapalı kuralını kaldıracak.",

        settingsTitle: "F4 Ayarları",
        tabGeneral: "Genel",
        tabEnergy: "Enerji",
        ...
        advancedResetDescription: "F4’e verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve F4’i Çöp Sepeti’ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "F4’i tamamen kaldır",
        advancedUninstallConfirmTitle: "F4 kaldırılsın mı?",
        advancedUninstallConfirmBody: "F4 izinlerini temizleyecek, tercihlerini kaldıracak ve Çöp Sepeti’ne taşınıp kapanacak. Bu işlem uygulama içinden geri alınamaz, ama Çöp Sepeti’ni boşaltana kadar orada kalır.",
        advancedUninstallFailedTitle: "Kaldırma durduruldu",
        advancedUninstallFailedBody: "F4 değiştirdiği bir sistem ayarını geri alamadı: uyku, fan hızı veya fare hızlandırması. Hiçbir şey silinmedi. Yeniden deneyin ve parola istenirse izin verin.",
        ...
        keepAwakeAutoStart: "F4 açılınca uyanık tut",
        ...
        switcherEnable: "F4 değiştiricisini kullan",
        ...
        switcherTakeOverSystemShortcutsCaption: "Eşleşen macOS uygulama ve pencere kısayollarını yalnızca F4 değiştiricisi etkinken kapatır. Çalışan tüm uygulamalara erişim korunur.",
        ...
        uninstallerFDAHint: "Listede F4’i aç. Orada yoksa + düğmesine tıkla ve Uygulamalar’dan F4’i seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        homebrewMissingBody: "F4, resmi Homebrew yükleyicisiyle Terminal’i açabilir. Terminal adımları gösterir ve gerekirse parolanı ister.",
        ...
        homebrewShellSetupBody: "Homebrew yüklü, ancak Terminal brew komutunu henüz bulamayabilir. F4, kurulum komutuyla Terminal’i açabilir.",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için Terminal’e ihtiyaç duyar. F4 parolaları yakalamaz.",
        ...
        updateNotifyTitle: "F4 güncellemesi",
        ...
        updateNeedsApplicationsTitle: "F4’i Uygulamalar klasörüne taşıyın",
        updateNeedsApplicationsBody: "Uygulama, disk görüntüsü veya geçici bir sistem konumu gibi güncellenemeyen bir yerden çalışıyor. F4’i Uygulamalar klasörüne sürükleyin, oradan açın ve yeniden deneyin.",
        ...
        secureInputHeldFormat: "%@ bunu açık tutuyor, bu yüzden F4 senin yerine yazamıyor. Serbest bırakmak için parola alanından çık ya da uygulamayı kapat.",
        secureInputUnattributed: "Çalışan hiçbir uygulama bunu üstlenmiyor. Temizlemek için oturumu kapatıp yeniden aç.",
        secureInputUnidentified: "Bunu açık tutan uygulama belirlenemedi, bu yüzden F4 senin yerine yazamıyor.",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için F4’in Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları’ndan izin ver ve tekrar dene.",
        ...
        donateHeading: "F4’in gelişmesine destek ol",
        donateMessage: "F4 ücretsiz, bağımsız ve boş zamanlarımda geliştiriliyor. Maddi destek olmak istersen Buy Me a Coffee, geliştirmeyi sürdürmeme doğrudan yardımcı olur.",
        donateButton: "Buy Me a Coffee ile destek ol",
        donateThanks: "Burada olduğun için teşekkürler. 🖤",
        supportIntroTitle: "F4’in gelişmesine destek ol",
        supportIntroMessage: "Geliştirmeye maddi destek olmak istersen bunu yapabileceğin tek yer Buy Me a Coffee.",
        supportIntroStarButton: "GitHub’da F4’e yıldız ver",
        supportIntroStarMessage: "Maddi destek asla beklenmez. GitHub’da verilen bir yıldız, daha fazla kişinin F4’i keşfetmesine yardımcı olur ve geliştirilmesinde gerçek bir fark yaratır.",
        supportIntroCoffeeButton: "Buy Me a Coffee ile destek ol",
        supportIntroLaterButton: "Şimdi değil",
        supportIntroDoneButton: "Tamam",
        discordIntroTitle: "F4 Discord topluluğu daha yeni başlıyor",
        discordIntroMessage: "F4 topluluğu yeni ve hâlâ şekilleniyor. Diğer kullanıcılarla tanışmak ve uygulamanın etrafında sıcak bir alan oluşturmaya yardım etmek için erkenden katıl.",
        ...
        communityIntroFollowButton: "X’te @f4’i takip et",
        homebrewOfficialIntroTitle: "Artık resmî Homebrew kataloğunda",
        homebrewOfficialIntroMessage: "F4 artık doğrudan resmî Homebrew kataloğundan kurulabilir.",
        ...
        showMenuBarIconCaption: "F4 simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac’lerde yaygındır), F4’i Uygulamalar’dan veya Spotlight’tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar.",
        ...
        menuBarIconManagerHintFormat: "%@ açık ve simgeyi gizli bölümünde tutuyor olabilir. F4’i orada arayın veya %@ uygulamasını F4’i her zaman gösterecek şekilde ayarlayın.",
        ...
        cleanerNotifDenied: "F4 bildirimleri sistemde kapalı.",
        cleanerNotifOpenSettings: "Bildirim ayarlarını aç…",
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. F4’i Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
        launchAtLoginNeedsApproval: "Giriş ögesi kayıtlı, ancak Sistem Ayarları’nda hâlâ kapalı. Sistem Ayarları › Genel › Giriş Ögeleri ve Uzantılar’ı açın ve “Oturum açılırken aç” altında F4’i açın.",
        ...
        mouseAccelerationCaption: "Bağlı farelerde işaretçi hızlandırmasını kaldırır. Seçenek kapatıldığında veya F4’ten çıkıldığında önceki ayar geri yüklenir.",

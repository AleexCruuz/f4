...
extension Strings {
    static let fr = Strings(
        statusIdleTooltip: "F4\u{00A0}: veille normale",
        statusActiveUntil: "F4\u{00A0}: éveillé jusqu’à",
        statusActiveIndefinite: "F4\u{00A0}: éveillé indéfiniment",
        ...
        notifyBatteryTitle: "F4 désactivé",
        notifyBatteryBody: "Batterie faible. La veille normale a été rétablie pour préserver la charge.",
        adminPromptClamshellOn: "F4 a besoin de votre mot de passe pour continuer écran rabattu.",
        adminPromptClamshellOff: "F4 a besoin de votre mot de passe pour rétablir la veille normale du Mac.",
        adminPromptRecover: "F4 a quitté alors que la veille du Mac était désactivée. Saisissez le mot de passe pour rétablir la veille normale.",
        adminPromptUpdate: "F4 a besoin de votre mot de passe pour installer la mise à jour.",
        adminPromptSudoersInstall: "F4 va créer une règle restreinte (pmset disablesleep uniquement) pour basculer le mode écran rabattu sans demander de mot de passe. C’est la seule fois où le mot de passe est nécessaire.",
        adminPromptSudoersRemove: "F4 va supprimer la règle d’écran rabattu sans mot de passe.",

        settingsTitle: "Réglages de F4",
        tabGeneral: "Général",
        tabEnergy: "Énergie",
        ...
        advancedResetDescription: "Retire toutes les autorisations que vous avez accordées à F4 (Accessibilité, Enregistrement de l’écran, Accès complet au disque et autres), l’élément d’ouverture et la règle d’écran rabattu. Utile pour repartir de zéro ou avant de désinstaller. L’app reste installée.",
        ...
        advancedUninstallDescription: "Fait tout ce qui précède, puis supprime les préférences et place F4 dans la corbeille, sans rien laisser. L’app quitte une fois terminé. Vous pouvez réinstaller à tout moment.",
        advancedUninstallButton: "Désinstaller complètement F4",
        advancedUninstallConfirmTitle: "Désinstaller F4\u{00A0}?",
        advancedUninstallConfirmBody: "F4 va effacer ses autorisations, supprimer ses préférences et se placer dans la corbeille, puis quitter. L’app ne peut pas annuler cette action, mais elle reste dans la corbeille jusqu’à ce que vous la vidiez.",
        advancedUninstallFailedTitle: "Désinstallation interrompue",
        advancedUninstallFailedBody: "F4 n’a pas pu rétablir un réglage système qu’il avait modifié\u{00A0}: la veille, la vitesse des ventilateurs ou l’accélération de la souris. Rien n’a été supprimé. Réessayez et autorisez la demande de mot de passe si elle apparaît.",
        ...
        keepAwakeAutoStart: "Garder éveillé à l’ouverture de F4",
        ...
        switcherEnable: "Utiliser le sélecteur F4",
        ...
        switcherTakeOverSystemShortcutsCaption: "Désactive les raccourcis macOS correspondants uniquement lorsque le sélecteur F4 est actif. Toutes les apps ouvertes restent accessibles.",
        ...
        uninstallerFDAHint: "Activez F4 dans la liste. S’il ne s’y trouve pas, cliquez sur + et choisissez F4 dans Applications. L’accès ne s’applique qu’après la réouverture de l’app.",
        ...
        homebrewMissingBody: "F4 peut ouvrir Terminal avec l’installateur officiel de Homebrew. Terminal affiche les étapes et demande votre mot de passe si nécessaire.",
        ...
        homebrewShellSetupBody: "Homebrew est installé, mais Terminal peut ne pas encore trouver la commande brew. F4 peut ouvrir Terminal avec la commande de configuration.",
        ...
        homebrewTerminalFallback: "Cette opération nécessite Terminal pour demander le mot de passe administrateur. F4 ne capture pas les mots de passe.",
        ...
        updateNotifyTitle: "Mise à jour de F4",
        ...
        updateNeedsApplicationsTitle: "Déplacez F4 vers Applications",
        updateNeedsApplicationsBody: "L’app s’exécute depuis un emplacement qui ne peut pas être mis à jour, comme l’image disque ou un emplacement temporaire du système. Faites glisser F4 dans le dossier Applications, ouvrez-le depuis là et réessayez.",
        ...
        secureInputHeldFormat: "%@ la maintient, F4 ne peut donc pas saisir de texte à votre place. Quittez son champ de mot de passe, ou fermez l’app, pour la libérer.",
        ...
        secureInputUnidentified: "L’app qui la maintient n’a pas pu être identifiée, F4 ne peut donc pas saisir de texte à votre place.",
        ...
        cleaningNeedsAxBody: "Pour verrouiller le clavier en toute sécurité, F4 a besoin de l’autorisation Accessibilité. Accordez-la dans les Réglages Système et réessayez.",
        ...
        donateHeading: "Aidez F4 à continuer de grandir",
        donateMessage: "F4 est gratuit, indépendant et développé pendant mon temps libre. Si vous souhaitez contribuer financièrement, Buy Me a Coffee aide directement à poursuivre son développement.",
        donateButton: "Soutenir sur Buy Me a Coffee",
        donateThanks: "Merci d’être là. 🖤",
        supportIntroTitle: "Aidez F4 à continuer de grandir",
        ...
        supportIntroStarButton: "Ajouter une étoile à F4 sur GitHub",
        supportIntroStarMessage: "Un soutien financier n’est jamais attendu. Une étoile sur GitHub aide davantage de personnes à découvrir F4 et fait une vraie différence pour son développement.",
        ...
        discordIntroTitle: "La communauté F4 sur Discord ne fait que commencer",
        discordIntroMessage: "La communauté F4 est nouvelle et se construit encore. Rejoignez-la dès maintenant pour rencontrer d’autres utilisateurs et créer un espace accueillant autour de l’app.",
        ...
        communityIntroFollowButton: "Suivre @f4 sur X",
        homebrewOfficialIntroTitle: "Maintenant dans le catalogue officiel de Homebrew",
        homebrewOfficialIntroMessage: "F4 peut maintenant être installé directement depuis le catalogue officiel de Homebrew.",
        ...
        showMenuBarIconCaption: "Si l’icône de F4 disparaît (macOS peut masquer des icônes lorsque la barre des menus manque de place, fréquent sur les Mac avec encoche), rouvrez F4 depuis Applications ou Spotlight\u{00A0}: cela recrée l’icône et, si elle reste masquée, ouvre cette fenêtre.",
        ...
        menuBarIconManagerHintFormat: "%@ est ouvert et garde peut-être l’icône dans sa section masquée. Cherchez F4 là-bas, ou réglez %@ pour toujours afficher F4.",
        ...
        cleanerNotifDenied: "Les notifications de F4 sont désactivées dans le système.",
        cleanerNotifOpenSettings: "Ouvrir les réglages de notifications…",
        launchAtLoginNeedsApplications: "L’app s’exécute depuis un emplacement qui ne permet pas l’ouverture à la connexion. Glissez F4 dans le dossier Applications, ouvrez l’app depuis ce dossier et réactivez l’option.",
        launchAtLoginNeedsApproval: "L’élément d’ouverture est enregistré, mais il reste désactivé dans les Réglages Système. Ouvrez Réglages Système › Général › Ouverture et extensions, puis activez F4 sous «\u{00A0}Ouvrir à la session\u{00A0}».",
        ...
        mouseAccelerationCaption: "Supprime l’accélération du pointeur pour les souris connectées. Le réglage précédent est restauré à la désactivation ou à la fermeture de F4.",

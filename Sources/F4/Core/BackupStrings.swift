...
extension BackupFeatureStrings {
    static let ko = BackupFeatureStrings(
        ...
        invalidFile: "이 파일은 유효한 F4 백업이 아닙니다.",
...
extension BackupFeatureStrings {
    static let enUS = BackupFeatureStrings(
        ...
        invalidFile: "This file is not a valid F4 backup.",
    ...
    static let ptBR = BackupFeatureStrings(
        ...
        invalidFile: "Este arquivo não é um backup válido do F4.",
    ...
    static let tr = BackupFeatureStrings(
        ...
        invalidFile: "Bu dosya geçerli bir F4 yedeği değil.",
    ...
    static let ru = BackupFeatureStrings(
        ...
        invalidFile: "Этот файл не является корректной резервной копией F4.",
    ...
    static let es = BackupFeatureStrings(
        ...
        invalidFile: "Este archivo no es una copia de seguridad válida de F4.",
    ...
    static let de = BackupFeatureStrings(
        ...
        invalidFile: "Diese Datei ist kein gültiges F4-Backup.",
    ...
    static let fr = BackupFeatureStrings(
        ...
        invalidFile: "Ce fichier n’est pas une sauvegarde F4 valide.",
    ...
    static let it = BackupFeatureStrings(
        ...
        invalidFile: "Questo file non è un backup F4 valido.",
    ...
    static let ja = BackupFeatureStrings(
        ...
        invalidFile: "このファイルは有効なF4のバックアップではありません。",

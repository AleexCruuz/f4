...
enum NotchNativeQueue {
    private static let work = DispatchQueue(label: "com.f4.now-playing-queue")
    private static let callbacks = DispatchQueue(label: "com.f4.now-playing-queue-callbacks")

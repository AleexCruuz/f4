...
private final class FanControlOwnership {
    private let lockPath = "/var/run/f4-fan-control.lock"
    private let markerPath = "/var/run/f4-fan-control.active"
...
private final class FanControlController {
    private let queue = DispatchQueue(label: "com.f4.fan-control.helper")

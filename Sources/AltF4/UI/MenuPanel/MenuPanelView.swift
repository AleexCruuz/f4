...
extension Notification.Name {
    static let menuPanelWillShow = Notification.Name("AltF4MenuPanelWillShow")
}
...
struct KeepAwakeCard: View {
    ...
    @AppStorage(DefaultsKey.keepAwakeActiveIcon) private var keepAwakeActiveIcon = KeepAwakeActiveIcon.altf4.rawValue

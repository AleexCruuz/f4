...
extension MouseButtonFeatureStrings {
    static let enUS = MouseButtonFeatureStrings(
        ...
        captureBlind: "AltF4 cannot watch the mouse right now.",
    ...
    static let ptBR = MouseButtonFeatureStrings(
        ...
        captureBlind: "O AltF4 não consegue observar o mouse agora.",
    ...
    static let tr = MouseButtonFeatureStrings(
        ...
        captureBlind: "AltF4 şu anda fareyi izleyemiyor.",
    ...
    static let ru = MouseButtonFeatureStrings(
        ...
        captureBlind: "AltF4 сейчас не может отслеживать мышь.",
    ...
    static let es = MouseButtonFeatureStrings(
        ...
        captureCancel: "Cancelar",
        captureBlind: "AltF4 no puede observar el ratón ahora mismo.",
    ...
    static let de = MouseButtonFeatureStrings(
        ...
        captureBlind: "AltF4 kann die Maus gerade nicht beobachten.",
    ...
    static let fr = MouseButtonFeatureStrings(
        ...
        captureBlind: "AltF4 ne peut pas observer la souris pour le moment.",
    ...
    static let it = MouseButtonFeatureStrings(
        ...
        captureBlind: "AltF4 al momento non riesce a osservare il mouse.",
    ...
    static let ja = MouseButtonFeatureStrings(
        ...
        captureCancel: "キャンセル",
        captureBlind: "AltF4は今マウスを監視できません。",
    ...
    static let ko = MouseButtonFeatureStrings(
        ...
        captureCancel: "취소",
        captureBlind: "AltF4가 지금은 마우스를 지켜볼 수 없습니다.",

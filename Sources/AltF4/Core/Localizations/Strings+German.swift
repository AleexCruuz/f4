...
extension Strings {
    static let de = Strings(
        statusIdleTooltip: "AltF4: normaler Ruhezustand",
        statusActiveUntil: "AltF4: aktiv bis",
        statusActiveIndefinite: "AltF4: dauerhaft aktiv",
        menuEnableAwake: "Wachhalten aktivieren",
        menuDisableAwake: "Wachhalten deaktivieren",
        menuActivateFor: "Aktivieren für…",
        menuSettings: "Einstellungen…",
        menuAbout: "Über AltF4",
        menuQuit: "AltF4 beenden",
        menuHide: "AltF4 ausblenden",
        ...
        notifyBatteryTitle: "AltF4 deaktiviert",
        notifyBatteryBody: "Niedriger Batteriestand. Der normale Ruhezustand wurde wiederhergestellt, um die Ladung zu schonen.",
        adminPromptClamshellOn: "AltF4 benötigt dein Passwort, um bei zugeklapptem Mac weiterzulaufen.",
        adminPromptClamshellOff: "AltF4 benötigt dein Passwort, um den normalen Ruhezustand des Mac wiederherzustellen.",
        adminPromptRecover: "AltF4 wurde beendet, während der Ruhezustand des Mac deaktiviert war. Gib das Passwort ein, um den normalen Ruhezustand wiederherzustellen.",
        adminPromptUpdate: "AltF4 benötigt dein Passwort, um das Update zu installieren.",
        adminPromptSudoersInstall: "AltF4 legt eine eingeschränkte Regel an (nur pmset disablesleep), um den Modus bei geschlossenem Display ohne Passwortabfrage umzuschalten. Nur dieses eine Mal wird das Passwort benötigt.",
        adminPromptSudoersRemove: "AltF4 entfernt die passwortfreie Regel für das geschlossene Display.",

        settingsTitle: "AltF4-Einstellungen",
        ...
        advancedResetDescription: "Entfernt alle Berechtigungen, die du AltF4 erteilt hast (Bedienungshilfen, Bildschirmaufnahme, Festplattenvollzugriff und weitere), das Anmeldeobjekt und die Regel für das geschlossene Display. Praktisch für einen Neustart oder vor dem Deinstallieren. Die App bleibt installiert.",
        ...
        advancedUninstallDescription: "Macht alles oben Genannte, entfernt dann die Einstellungen und bewegt AltF4 in den Papierkorb, ohne Rückstände zu hinterlassen. Die App beendet sich danach. Du kannst sie jederzeit neu installieren.",
        advancedUninstallButton: "AltF4 vollständig deinstallieren",
        advancedUninstallConfirmTitle: "AltF4 deinstallieren?",
        advancedUninstallConfirmBody: "AltF4 setzt seine Berechtigungen zurück, entfernt seine Einstellungen und wandert in den Papierkorb, dann beendet es sich. Das lässt sich aus der App nicht rückgängig machen, doch sie bleibt im Papierkorb, bis du ihn leerst.",
        advancedUninstallFailedTitle: "Deinstallation gestoppt",
        advancedUninstallFailedBody: "AltF4 konnte eine geänderte Systemeinstellung nicht wiederherstellen: Ruhezustand, Lüfterdrehzahl oder Mausbeschleunigung. Es wurde nichts entfernt. Versuche es erneut und erlaube die Kennwortabfrage, falls sie erscheint.",
        ...
        keepAwakeAutoStart: "Beim Öffnen von AltF4 wach halten",
        ...
        switcherEnable: "AltF4-Umschalter verwenden",
        ...
        switcherTakeOverSystemShortcutsCaption: "Deaktiviert die passenden macOS-App- und Fensterkurzbefehle nur, solange AltF4s Umschalter aktiv ist. Alle laufenden Apps bleiben erreichbar.",
        ...
        uninstallerFDAHint: "Aktiviere AltF4 in der Liste. Fehlt es dort, klicke auf + und wähle AltF4 unter „Programme“. Der Zugriff gilt erst, nachdem du die App erneut öffnest.",
        ...
        homebrewMissingBody: "AltF4 kann Terminal mit dem offiziellen Homebrew-Installer öffnen. Terminal zeigt die Schritte und fragt bei Bedarf nach deinem Passwort.",
        ...
        homebrewShellSetupBody: "Homebrew ist installiert, aber Terminal findet den Befehl brew vielleicht noch nicht. AltF4 kann Terminal mit dem Konfigurationsbefehl öffnen.",
        ...
        homebrewTerminalFallback: "Diese Aktion benötigt Terminal, um nach dem Administratorpasswort zu fragen. AltF4 erfasst keine Passwörter.",
        ...
        updateNeedsApplicationsTitle: "Bewege AltF4 in den Ordner „Programme“",
        updateNeedsApplicationsBody: "Die App läuft an einem Ort, der nicht aktualisiert werden kann, etwa im Disk-Image oder an einem temporären Systemort. Ziehe AltF4 in den Ordner „Programme“, öffne es von dort und versuche es erneut.",
        ...
        secureInputHeldFormat: "%@ hält sie, daher kann AltF4 nicht für dich tippen. Verlasse das Passwortfeld oder beende die App, um sie freizugeben.",
        secureInputUnattributed: "Keine laufende App beansprucht sie. Melde dich ab und wieder an, um sie zurückzusetzen.",
        secureInputUnidentified: "Die App, die sie hält, konnte nicht identifiziert werden, daher kann AltF4 nicht für dich tippen.",
        ...
        obStart: "AltF4 öffnen",
        obStepWelcomeTitle: "Willkommen bei AltF4",
        ...
        obStepDoneBody: "AltF4 kümmert sich bereits um deinen Mac.",
        ...
        obLanguageUpdateBody: "AltF4 spricht jetzt mehrere Sprachen. Wähle die, die du verwenden möchtest; du kannst sie jederzeit in den Einstellungen ändern.",
        ...
        cleaningNeedsAxBody: "Um die Tastatur sicher zu sperren, benötigt AltF4 die Berechtigung für Bedienungshilfen. Erteile sie in den Systemeinstellungen und versuche es erneut.",
        ...
        donateHeading: "Hilf AltF4 weiter zu wachsen",
        donateMessage: "AltF4 ist kostenlos, unabhängig und entsteht in meiner Freizeit. Wenn du die Entwicklung finanziell unterstützen möchtest, hilft Buy Me a Coffee direkt dabei, sie voranzubringen.",
        donateButton: "Über Buy Me a Coffee unterstützen",
        donateThanks: "Danke, dass du hier bist. 🖤",
        supportIntroTitle: "Hilf AltF4 weiter zu wachsen",
        supportIntroMessage: "Wenn du die Entwicklung finanziell unterstützen möchtest, ist Buy Me a Coffee der einzige Ort dafür.",
        supportIntroStarButton: "AltF4 auf GitHub einen Stern geben",
        supportIntroStarMessage: "Finanzielle Unterstützung wird nie erwartet. Ein Stern auf GitHub hilft mehr Menschen, AltF4 zu entdecken, und macht für die Entwicklung einen echten Unterschied.",
        ...
        discordIntroTitle: "Die AltF4 Community auf Discord steht noch am Anfang",
        discordIntroMessage: "Die AltF4 Community ist neu und wächst noch. Tritt früh bei, lerne andere Nutzer kennen und hilf, einen einladenden Ort rund um die App aufzubauen.",
        ...
        communityIntroFollowButton: "@altf4 auf X folgen",
        homebrewOfficialIntroTitle: "Jetzt im offiziellen Katalog von Homebrew",
        homebrewOfficialIntroMessage: "AltF4 kann jetzt direkt aus dem offiziellen Katalog von Homebrew installiert werden.",
        ...
        showMenuBarIconCaption: "Falls das Symbol von AltF4 verschwindet (macOS kann Menüleistensymbole ausblenden, wenn der Platz in der Leiste knapp wird, häufig bei Macs mit Notch), öffne AltF4 erneut über „Programme“ oder Spotlight: Das stellt das Symbol wieder her und öffnet, falls es weiterhin ausgeblendet ist, dieses Fenster.",
        ...
        menuBarIconManagerHintFormat: "%@ läuft und hält das Symbol womöglich in seinem verborgenen Bereich. Suche AltF4 dort, oder stelle %@ so ein, dass AltF4 immer angezeigt wird.",
        ...
        cleanerNotifDenied: "Mitteilungen von AltF4 sind im System deaktiviert.",
        cleanerNotifOpenSettings: "Mitteilungseinstellungen öffnen…",
        launchAtLoginNeedsApplications: "Die App läuft von einem Ort, der das Öffnen bei der Anmeldung nicht erlaubt. Ziehe AltF4 in den Ordner Programme, öffne die App von dort und schalte die Option wieder ein.",
        launchAtLoginNeedsApproval: "Das Anmeldeobjekt ist registriert, in den Systemeinstellungen aber weiterhin aus. Öffne Systemeinstellungen › Allgemein › Anmeldeobjekte & Erweiterungen und schalte AltF4 unter „Bei der Anmeldung öffnen“ ein.",
        ...
        mouseAccelerationCaption: "Deaktiviert die Zeigerbeschleunigung für angeschlossene Mäuse. Die vorherige Einstellung wird beim Ausschalten oder Beenden von AltF4 wiederhergestellt.",

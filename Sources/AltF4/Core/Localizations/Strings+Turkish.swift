...
extension Strings {
    static let tr = Strings(
        statusIdleTooltip: "AltF4: normal uyku",
        statusActiveUntil: "AltF4: şu zamana kadar uyanık",
        statusActiveIndefinite: "AltF4: süresiz uyanık",
        ...
        menuAbout: "AltF4 Hakkında",
        menuQuit: "AltF4’ten Çık",
        menuHide: "AltF4’i Gizle",
        ...
        notifyBatteryTitle: "AltF4 devre dışı",
        notifyBatteryBody: "Pil düşük. Şarjı korumak için normal uyku geri yüklendi.",
        adminPromptClamshellOn: "AltF4’in, Mac’i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "AltF4’in, Mac’in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        adminPromptRecover: "Mac’in uykusu kapalıyken AltF4 kapandı. Normal uykuyu geri yüklemek için parolayı gir.",
        adminPromptUpdate: "AltF4 güncellemeyi yüklemek için parolanıza ihtiyaç duyuyor.",
        adminPromptSudoersInstall: "AltF4, parola sormadan kapak kapalı modunu açıp kapatmak için kısıtlı bir kural oluşturacak (yalnızca pmset disablesleep). Parolanın gerektiği tek zaman bu.",
        adminPromptSudoersRemove: "AltF4, parolasız kapak kapalı kuralını kaldıracak.",

        settingsTitle: "AltF4 Ayarları",
        tabGeneral: "Genel",
        tabEnergy: "Enerji",
        ...
        advancedResetDescription: "AltF4’e verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve AltF4’i Çöp Sepeti’ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "AltF4’i tamamen kaldır",
        advancedUninstallConfirmTitle: "AltF4 kaldırılsın mı?",
        advancedUninstallConfirmBody: "AltF4 izinlerini temizleyecek, tercihlerini kaldıracak ve Çöp Sepeti’ne taşınıp kapanacak. Bu işlem uygulama içinden geri alınamaz, ama Çöp Sepeti’ni boşaltana kadar orada kalır.",
        advancedUninstallFailedTitle: "Kaldırma durduruldu",
        advancedUninstallFailedBody: "AltF4 değiştirdiği bir sistem ayarını geri alamadı: uyku, fan hızı veya fare hızlandırması. Hiçbir şey silinmedi. Yeniden deneyin ve parola istenirse izin verin.",
        ...
        keepAwakeAutoStart: "AltF4 açılınca uyanık tut",
        ...
        switcherEnable: "AltF4 değiştiricisini kullan",
        ...
        switcherTakeOverSystemShortcutsCaption: "Eşleşen macOS uygulama ve pencere kısayollarını yalnızca AltF4 değiştiricisi etkinken kapatır. Çalışan tüm uygulamalara erişim korunur.",
        ...
        uninstallerFDAHint: "Listede AltF4’i aç. Orada yoksa + düğmesine tıkla ve Uygulamalar’dan AltF4’i seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        homebrewMissingBody: "AltF4, resmi Homebrew yükleyicisiyle Terminal’i açabilir. Terminal adımları gösterir ve gerekirse parolanı ister.",
        ...
        homebrewShellSetupBody: "Homebrew yüklü, ancak Terminal brew komutunu henüz bulamayabilir. AltF4, kurulum komutuyla Terminal’i açabilir.",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için Terminal’e ihtiyaç duyar. AltF4 parolaları yakalamaz.",
        ...
        updateNotifyTitle: "AltF4 güncellemesi",
        ...
        updateNeedsApplicationsTitle: "AltF4’i Uygulamalar klasörüne taşıyın",
        updateNeedsApplicationsBody: "Uygulama, disk görüntüsü veya geçici bir sistem konumu gibi güncellenemeyen bir yerden çalışıyor. AltF4’i Uygulamalar klasörüne sürükleyin, oradan açın ve yeniden deneyin.",
        ...
        secureInputHeldFormat: "%@ bunu açık tutuyor, bu yüzden AltF4 senin yerine yazamıyor. Serbest bırakmak için parola alanından çık ya da uygulamayı kapat.",
        secureInputUnattributed: "Çalışan hiçbir uygulama bunu üstlenmiyor. Temizlemek için oturumu kapatıp yeniden aç.",
        secureInputUnidentified: "Bunu açık tutan uygulama belirlenemedi, bu yüzden AltF4 senin yerine yazamıyor.",
        ...
        obStart: "AltF4’i aç",
        obStepWelcomeTitle: "AltF4’e hoş geldin",
        ...
        obStepDoneBody: "AltF4 Mac’inle ilgilenmeye başladı bile.",
        ...
        obLanguageUpdateBody: "AltF4 artık birçok dil konuşuyor. Kullanmak istediğin dili seç; bunu istediğin zaman Ayarlar’dan değiştirebilirsin.",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için AltF4’in Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları’ndan izin ver ve tekrar dene.",
        ...
        donateHeading: "AltF4’in gelişmesine destek ol",
        donateMessage: "AltF4 ücretsiz, bağımsız ve boş zamanlarımda geliştiriliyor. Maddi destek olmak istersen Buy Me a Coffee, geliştirmeyi sürdürmeme doğrudan yardımcı olur.",
        donateButton: "Buy Me a Coffee ile destek ol",
        donateThanks: "Burada olduğun için teşekkürler. 🖤",
        supportIntroTitle: "AltF4’in gelişmesine destek ol",
        supportIntroMessage: "Geliştirmeye maddi destek olmak istersen bunu yapabileceğin tek yer Buy Me a Coffee.",
        supportIntroStarButton: "GitHub’da AltF4’e yıldız ver",
        supportIntroStarMessage: "Maddi destek asla beklenmez. GitHub’da verilen bir yıldız, daha fazla kişinin AltF4’i keşfetmesine yardımcı olur ve geliştirilmesinde gerçek bir fark yaratır.",
        supportIntroCoffeeButton: "Buy Me a Coffee ile destek ol",
        supportIntroLaterButton: "Şimdi değil",
        supportIntroDoneButton: "Tamam",
        discordIntroTitle: "AltF4 Discord topluluğu daha yeni başlıyor",
        discordIntroMessage: "AltF4 topluluğu yeni ve hâlâ şekilleniyor. Diğer kullanıcılarla tanışmak ve uygulamanın etrafında sıcak bir alan oluşturmaya yardım etmek için erkenden katıl.",
        ...
        communityIntroFollowButton: "X’te @altf4’i takip et",
        homebrewOfficialIntroTitle: "Artık resmî Homebrew kataloğunda",
        homebrewOfficialIntroMessage: "AltF4 artık doğrudan resmî Homebrew kataloğundan kurulabilir.",
        ...
        showMenuBarIconCaption: "AltF4 simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac’lerde yaygındır), AltF4’i Uygulamalar’dan veya Spotlight’tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar.",
        ...
        menuBarIconManagerHintFormat: "%@ açık ve simgeyi gizli bölümünde tutuyor olabilir. AltF4’i orada arayın veya %@ uygulamasını AltF4’i her zaman gösterecek şekilde ayarlayın.",
        ...
        cleanerNotifDenied: "AltF4 bildirimleri sistemde kapalı.",
        cleanerNotifOpenSettings: "Bildirim ayarlarını aç…",
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. AltF4’i Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
        launchAtLoginNeedsApproval: "Giriş ögesi kayıtlı, ancak Sistem Ayarları’nda hâlâ kapalı. Sistem Ayarları › Genel › Giriş Ögeleri ve Uzantılar’ı açın ve “Oturum açılırken aç” altında AltF4’i açın.",
        ...
        mouseAccelerationCaption: "Bağlı farelerde işaretçi hızlandırmasını kaldırır. Seçenek kapatıldığında veya AltF4’ten çıkıldığında önceki ayar geri yüklenir.",

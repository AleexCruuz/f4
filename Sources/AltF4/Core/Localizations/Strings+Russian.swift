...
extension Strings {
    static let ru = Strings(
        statusIdleTooltip: "AltF4: обычный сон",
        statusActiveUntil: "AltF4: активно до",
        statusActiveIndefinite: "AltF4: активно без срока",
        menuEnableAwake: "Включить режим без сна",
        menuDisableAwake: "Выключить режим без сна",
        menuActivateFor: "Включить на…",
        menuSettings: "Настройки…",
        menuAbout: "О AltF4",
        menuQuit: "Выйти из AltF4",
        menuHide: "Скрыть AltF4",
        ...
        notifyBatteryTitle: "AltF4 отключён",
        notifyBatteryBody: "Низкий заряд. Обычный сон восстановлен, чтобы сохранить батарею.",
        adminPromptClamshellOn: "AltF4 нужен ваш пароль, чтобы Mac продолжал работать с закрытой крышкой.",
        adminPromptClamshellOff: "AltF4 нужен ваш пароль, чтобы вернуть обычный режим сна Mac.",
        adminPromptRecover: "AltF4 завершился, пока сон Mac был отключён. Введите пароль, чтобы вернуть обычный режим сна.",
        adminPromptUpdate: "AltF4 нужен ваш пароль, чтобы установить обновление.",
        adminPromptSudoersInstall: "AltF4 создаст ограниченное правило (только pmset disablesleep), чтобы переключать режим закрытой крышки без запроса пароля. Пароль понадобится только сейчас.",
        adminPromptSudoersRemove: "AltF4 удалит правило для режима закрытой крышки без пароля.",

        settingsTitle: "Настройки AltF4",
        tabGeneral: "Основное",
        tabEnergy: "Питание",
        ...
        advancedResetDescription: "Удаляет все разрешения, которые вы дали AltF4 (Универсальный доступ, Запись экрана, Полный доступ к диску и другие), элемент входа и правило закрытой крышки. Полезно, если хотите начать с чистого листа или перед удалением. Приложение останется установленным.",
        ...
        advancedUninstallDescription: "Сделает всё вышеперечисленное, затем удалит настройки и переместит AltF4 в Корзину без остатка. После завершения приложение закроется. Установить его снова можно в любой момент.",
        advancedUninstallButton: "Удалить AltF4 полностью",
        advancedUninstallConfirmTitle: "Удалить AltF4?",
        advancedUninstallConfirmBody: "AltF4 очистит разрешения, удалит настройки и переместится в Корзину, после чего закроется. Это нельзя отменить из приложения, но файл останется в Корзине, пока вы её не очистите.",
        advancedUninstallFailedTitle: "Удаление остановлено",
        advancedUninstallFailedBody: "AltF4 не смог вернуть изменённую системную настройку: режим сна, скорость вентиляторов или ускорение мыши. Ничего не удалено. Повторите попытку и разрешите запрос пароля, если он появится.",
        ...
        keepAwakeAutoStart: "Не давать уснуть при запуске AltF4",
        ...
        switcherEnable: "Использовать переключатель AltF4",
        ...
        switcherTakeOverSystemShortcutsCaption: "Отключает соответствующие сочетания macOS только на время работы переключателя AltF4. Все запущенные приложения остаются доступны.",
        ...
        uninstallerFDAHint: "Включите AltF4 в списке. Если его там нет, нажмите + и выберите AltF4 из папки «Программы». Доступ начнёт действовать только после повторного запуска приложения.",
        ...
        homebrewMissingBody: "AltF4 может открыть Терминал с официальным установщиком Homebrew. Терминал покажет шаги и при необходимости запросит ваш пароль.",
        ...
        homebrewShellSetupBody: "Homebrew установлен, но Терминал может ещё не видеть команду brew. AltF4 может открыть Терминал с нужной командой настройки.",
        ...
        homebrewTerminalFallback: "Для этой операции нужен Терминал, чтобы запросить пароль администратора. AltF4 не перехватывает пароли.",
        ...
        updateNotifyTitle: "Обновление AltF4",
        ...
        updateNeedsApplicationsTitle: "Переместите AltF4 в папку «Программы»",
        updateNeedsApplicationsBody: "Приложение запущено из места, которое нельзя обновить, например из образа диска или временного системного расположения. Перетащите AltF4 в папку «Программы», откройте его оттуда и попробуйте снова.",
        ...
        secureInputHeldFormat: "Его удерживает %@, поэтому AltF4 не может печатать за вас. Снимите фокус с поля пароля или завершите работу приложения, чтобы освободить его.",
        ...
        secureInputUnidentified: "Не удалось определить приложение, которое его удерживает, поэтому AltF4 не может печатать за вас.",
        ...
        obStart: "Открыть AltF4",
        obStepWelcomeTitle: "Добро пожаловать в AltF4",
        ...
        obStepDoneBody: "AltF4 уже заботится о вашем Mac.",
        ...
        obLanguageUpdateBody: "Теперь AltF4 говорит на нескольких языках. Выберите тот, который хотите использовать; в любой момент его можно сменить в Настройках.",
        ...
        cleaningNeedsAxBody: "Чтобы безопасно блокировать клавиатуру, AltF4 нужен доступ к Универсальному доступу. Выдайте его в Системных настройках и попробуйте снова.",
        ...
        donateHeading: "Помогите AltF4 развиваться",
        donateMessage: "AltF4 бесплатен, независим и создаётся в моё свободное время. Если вы хотите помочь финансово, Buy Me a Coffee напрямую поддерживает дальнейшую разработку.",
        donateButton: "Поддержать через Buy Me a Coffee",
        donateThanks: "Спасибо, что вы здесь. 🖤",
        supportIntroTitle: "Помогите AltF4 развиваться",
        supportIntroMessage: "Если вы хотите финансово поддержать разработку, сделать это можно только через Buy Me a Coffee.",
        supportIntroStarButton: "Поставить AltF4 звезду на GitHub",
        supportIntroStarMessage: "Финансовая поддержка совсем не обязательна. Звезда на GitHub помогает большему числу людей найти AltF4 и действительно влияет на его развитие.",
        supportIntroCoffeeButton: "Поддержать через Buy Me a Coffee",
        supportIntroLaterButton: "Не сейчас",
        supportIntroDoneButton: "Готово",
        discordIntroTitle: "Сообщество AltF4 в Discord только начинает расти",
        discordIntroMessage: "Сообщество AltF4 новое и всё ещё формируется. Присоединяйтесь сейчас, знакомьтесь с другими пользователями и помогите создать дружелюбное пространство вокруг приложения.",
        ...
        communityIntroFollowButton: "Подписаться на @altf4 в X",
        homebrewOfficialIntroTitle: "Теперь в официальном каталоге Homebrew",
        homebrewOfficialIntroMessage: "Теперь AltF4 можно установить прямо из официального каталога Homebrew.",
        ...
        showMenuBarIconCaption: "Если значок AltF4 исчезнет (macOS может скрывать значки строки меню, когда в ней не хватает места, что часто бывает на Mac с вырезом), откройте AltF4 снова из папки «Программы» или через Spotlight: это пересоздаст значок и, если он всё ещё скрыт, откроет это окно.",
        ...
        menuBarIconManagerHintFormat: "%@ запущен и, возможно, держит значок в своей скрытой секции. Поищите AltF4 там или настройте %@ всегда показывать AltF4.",
        ...
        cleanerNotifDenied: "Уведомления AltF4 отключены в системе.",
        cleanerNotifOpenSettings: "Открыть настройки уведомлений…",
        launchAtLoginNeedsApplications: "Приложение запущено из места, из которого нельзя открываться при входе. Перетащите AltF4 в папку «Программы», откройте его оттуда и включите параметр снова.",
        launchAtLoginNeedsApproval: "Объект входа зарегистрирован, но в Системных настройках он выключен. Откройте «Системные настройки › Основные › Объекты входа и расширения» и включите AltF4 в разделе «Открывать при входе».",
        ...
        mouseAccelerationCaption: "Отключает ускорение указателя для подключённых мышей. Прежняя настройка вернётся после выключения функции или выхода из AltF4.",

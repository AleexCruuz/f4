...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "AltF4: reposo normal",
        statusActiveUntil: "AltF4: activo hasta",
        statusActiveIndefinite: "AltF4: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de AltF4",
        menuQuit: "Salir de AltF4",
        menuHide: "Ocultar AltF4",
        ...
        notifyBatteryTitle: "AltF4 desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "AltF4 necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "AltF4 necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "AltF4 se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "AltF4 necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "AltF4 creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "AltF4 eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de AltF4",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a AltF4 (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve AltF4 a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar AltF4 por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar AltF4?",
        advancedUninstallConfirmBody: "AltF4 borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        advancedUninstallFailedTitle: "La desinstalación se detuvo",
        advancedUninstallFailedBody: "AltF4 no pudo restaurar un ajuste del sistema que había cambiado: la suspensión, la velocidad de los ventiladores o la aceleración del ratón. No se eliminó nada. Inténtalo de nuevo y permite la solicitud de contraseña si aparece.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir AltF4",
        ...
        switcherEnable: "Usar el selector de AltF4",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desactiva los atajos correspondientes de macOS solo mientras el selector de AltF4 está activo. Todas las apps abiertas siguen accesibles.",
        ...
        uninstallerFDAHint: "Activa AltF4 en la lista. Si no aparece, haz clic en + y elige AltF4 en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        homebrewMissingBody: "AltF4 puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. AltF4 puede abrir Terminal con el comando de configuración.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. AltF4 no captura contraseñas.",
        ...
        updateNotifyTitle: "Actualización de AltF4",
        ...
        updateNeedsApplicationsTitle: "Mueve AltF4 a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra AltF4 a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        secureInputHeldFormat: "%@ la está reteniendo, por lo que AltF4 no puede escribir por ti. Sal de su campo de contraseña, o ciérrala, para liberarla.",
        secureInputUnattributed: "Ninguna app en ejecución la reclama. Cierra la sesión y vuelve a iniciarla para borrarla.",
        secureInputUnidentified: "No se ha podido identificar la app que la está reteniendo, por lo que AltF4 no puede escribir por ti.",
        ...
        obStart: "Abrir AltF4",
        obStepWelcomeTitle: "Te damos la bienvenida a AltF4",
        ...
        obStepDoneBody: "AltF4 ya está cuidando de tu Mac.",
        ...
        obLanguageUpdateBody: "AltF4 ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, AltF4 necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Ayuda a que AltF4 siga creciendo",
        donateMessage: "AltF4 es gratis, independiente y lo desarrollo en mi tiempo libre. Si quieres contribuir económicamente, Buy Me a Coffee ayuda directamente a mantener el desarrollo en marcha.",
        donateButton: "Apoyar en Buy Me a Coffee",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Ayuda a que AltF4 siga creciendo",
        supportIntroMessage: "Si quieres apoyar económicamente el desarrollo, Buy Me a Coffee es el único lugar para hacerlo.",
        supportIntroStarButton: "Dar una estrella a AltF4 en GitHub",
        supportIntroStarMessage: "Nunca se espera apoyo económico. Una estrella en GitHub ayuda a que más personas descubran AltF4 y marca una diferencia real en su desarrollo.",
        supportIntroCoffeeButton: "Apoyar en Buy Me a Coffee",
        supportIntroLaterButton: "Ahora no",
        supportIntroDoneButton: "Listo",
        discordIntroTitle: "La comunidad de AltF4 en Discord acaba de empezar",
        discordIntroMessage: "La comunidad de AltF4 es nueva y todavía está tomando forma. Únete desde el principio para conocer a otros usuarios y ayudar a crear un espacio acogedor alrededor de la app.",
        ...
        communityIntroFollowButton: "Seguir a @altf4 en X",
        homebrewOfficialIntroTitle: "Ahora en el catálogo oficial de Homebrew",
        homebrewOfficialIntroMessage: "AltF4 ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de AltF4 desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir AltF4 desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca AltF4 ahí, o configura %@ para mostrar siempre AltF4.",
        ...
        cleanerNotifDenied: "Las notificaciones de AltF4 están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra AltF4 a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
        launchAtLoginNeedsApproval: "El ítem de inicio está registrado, pero sigue desactivado en Ajustes del Sistema. Abre Ajustes del Sistema › General › Ítems de inicio y extensiones y activa AltF4 en “Abrir al iniciar sesión”.",
        ...
        mouseAccelerationCaption: "Elimina la aceleración del puntero para los ratones conectados. El ajuste anterior vuelve al desactivarlo o salir de AltF4.",

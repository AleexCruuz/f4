...
extension RadialMenuFeatureStrings {
    static let enUS = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 sees this button",
        buttonTestOther: "That was a different button",
        buttonTestBlind: "AltF4 cannot watch the mouse right now",
    ...
    static let ptBR = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "O AltF4 enxerga esse botão",
        buttonTestOther: "Esse foi outro botão",
        buttonTestBlind: "O AltF4 não consegue observar o mouse agora",
    ...
    static let tr = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 bu düğmeyi görüyor",
        buttonTestOther: "Bu başka bir düğmeydi",
        buttonTestBlind: "AltF4 şu anda fareyi izleyemiyor",
    ...
    static let ru = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 видит эту кнопку",
        buttonTestOther: "Это была другая кнопка",
        buttonTestBlind: "AltF4 сейчас не может следить за мышью",
    ...
    static let es = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 ve este botón",
        buttonTestOther: "Ese fue otro botón",
        buttonTestBlind: "AltF4 no puede observar el ratón ahora",
    ...
    static let de = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 sieht diese Taste",
        buttonTestOther: "Das war eine andere Taste",
        buttonTestBlind: "AltF4 kann die Maus gerade nicht beobachten",
    ...
    static let fr = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 voit ce bouton",
        buttonTestOther: "C’était un autre bouton",
        buttonTestBlind: "AltF4 ne peut pas observer la souris pour le moment",
    ...
    static let it = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 vede questo pulsante",
        buttonTestOther: "Quello era un altro pulsante",
        buttonTestBlind: "AltF4 non riesce a osservare il mouse in questo momento",
    ...
    static let ja = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 はこのボタンを認識しています",
        buttonTestOther: "いまのは別のボタンです",
        buttonTestBlind: "AltF4 はいまマウスを見られません",
    ...
    static let ko = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4가 이 버튼을 인식합니다",
        buttonTestOther: "방금 것은 다른 버튼입니다",
        buttonTestBlind: "지금은 AltF4가 마우스를 살펴볼 수 없습니다",
    ...
    static let zhHans = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 能看到这个按键",
        buttonTestOther: "刚才是另一个按键",
        buttonTestBlind: "AltF4 现在无法观察鼠标",
    ...
    static let zhTW = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "AltF4 看得到這個按鍵",
        buttonTestOther: "剛才是另一個按鍵",
        buttonTestBlind: "AltF4 目前無法觀察滑鼠",

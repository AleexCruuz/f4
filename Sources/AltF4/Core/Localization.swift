...
struct Strings {
    ...
    let keepAwakeActiveIconAltF4: String
...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "AltF4: suspensão normal",
        statusActiveUntil: "AltF4: ativo até",
        statusActiveIndefinite: "AltF4: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o AltF4",
        menuQuit: "Sair do AltF4",
        menuHide: "Ocultar o AltF4",
        ...
        keepAwakeActiveIconAltF4: "AltF4",
        ...
        notifyBatteryTitle: "AltF4 desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O AltF4 precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O AltF4 precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O AltF4 foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O AltF4 precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O AltF4 vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O AltF4 vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do AltF4",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao AltF4 (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o AltF4 para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o AltF4 completamente",
        advancedUninstallConfirmTitle: "Desinstalar o AltF4?",
        advancedUninstallConfirmBody: "O AltF4 vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        advancedUninstallFailedTitle: "A desinstalação parou",
        advancedUninstallFailedBody: "O AltF4 não conseguiu restaurar uma configuração do sistema que ele mudou: repouso, velocidade das ventoinhas ou aceleração do mouse. Nada foi removido. Tente de novo e permita o pedido de senha, se ele aparecer.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o AltF4",
        ...
        switcherEnable: "Usar o alternador do AltF4",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desativa os atalhos correspondentes de apps e janelas do macOS somente enquanto o alternador do AltF4 estiver ativo. Todos os apps abertos continuam acessíveis.",
        ...
        uninstallerFDAHint: "Ative o AltF4 na lista. Se ele não aparecer, clique no + e escolha o AltF4 em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O AltF4 pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O AltF4 pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O AltF4 não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do AltF4",
        ...
        updateNeedsApplicationsTitle: "Mova o AltF4 para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o AltF4 para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        secureInputUnidentified: "Não foi possível identificar o app que a está mantendo ativa, então o AltF4 não consegue digitar por você.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o AltF4 precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o AltF4 a continuar crescendo",
        donateMessage: "O AltF4 é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no Buy Me a Coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o AltF4 a continuar crescendo",
        ...
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o AltF4 e faz uma diferença enorme no desenvolvimento.",
        supportIntroCoffeeButton: "Apoiar no Buy Me a Coffee",
        supportIntroLaterButton: "Agora não",
        supportIntroDoneButton: "Concluir",
        discordIntroTitle: "A comunidade do AltF4 no Discord está começando",
        discordIntroMessage: "A comunidade do AltF4 é nova e ainda está em desenvolvimento. Entre desde o começo para conhecer outros usuários e ajudar a construir um espaço acolhedor em torno do app.",
        ...
        communityIntroFollowButton: "Seguir @altf4 no X",
        homebrewOfficialIntroTitle: "Agora no catálogo oficial do Homebrew",
        homebrewOfficialIntroMessage: "O AltF4 agora pode ser instalado direto do catálogo oficial do Homebrew.",
        ...
        showMenuBarIconCaption: "Se o ícone do AltF4 sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o AltF4 pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o AltF4 lá, ou configure o %@ para sempre mostrar o AltF4.",
        ...
        cleanerNotifDenied: "As notificações do AltF4 estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o AltF4 para a pasta Aplicativos, abra de lá e ligue de novo.",
        launchAtLoginNeedsApproval: "O item de login está registrado, mas continua desligado nos Ajustes do Sistema. Abra Ajustes do Sistema › Geral › Itens de Início e Extensões e ligue o AltF4 em “Abrir ao iniciar sessão”.",
        ...
        mouseAccelerationCaption: "Remove a aceleração do cursor para os mouses conectados. A configuração anterior volta ao desligar esta opção ou sair do AltF4.",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "AltF4: normal sleep",
        statusActiveUntil: "AltF4: awake until",
        statusActiveIndefinite: "AltF4: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About AltF4",
        menuQuit: "Quit AltF4",
        menuHide: "Hide AltF4",
        ...
        notifyBatteryTitle: "AltF4 disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "AltF4 needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "AltF4 needs your password to restore the Mac’s normal sleep.",
        adminPromptRecover: "AltF4 quit while the Mac’s sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "AltF4 needs your password to install the update.",
        adminPromptSudoersInstall: "AltF4 will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "AltF4 will remove the password-free closed-lid rule.",

        settingsTitle: "AltF4 Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted AltF4 (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves AltF4 to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall AltF4 completely",
        advancedUninstallConfirmTitle: "Uninstall AltF4?",
        advancedUninstallConfirmBody: "AltF4 will clear its permissions, remove its preferences and move to the Trash, then quit. This can’t be undone from the app, but it stays in the Trash until you empty it.",
        advancedUninstallFailedTitle: "Uninstall stopped",
        advancedUninstallFailedBody: "AltF4 could not put back a system setting it changed: sleep, fan speed or mouse acceleration. Nothing was removed. Try again and allow the password request if it appears.",
        ...
        keepAwakeAutoStart: "Keep Awake when AltF4 opens",
        ...
        switcherEnable: "Use the AltF4 switcher",
        ...
        switcherTakeOverSystemShortcutsCaption: "Disables the matching macOS app and window shortcuts only while AltF4’s switcher is active. All running apps stay reachable.",
        ...
        uninstallerFDAHint: "Turn AltF4 on in the list. If it isn’t there, click + and pick AltF4 from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "AltF4 can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. AltF4 can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. AltF4 does not capture passwords.",
        ...
        updateNotifyTitle: "AltF4 update",
        ...
        updateNeedsApplicationsTitle: "Move AltF4 to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag AltF4 to the Applications folder, open it from there and try again.",
        ...
        secureInputUnidentified: "The app holding it could not be identified, so AltF4 cannot type for you.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, AltF4 needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help AltF4 keep growing",
        donateMessage: "AltF4 is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help AltF4 keep growing",
        supportIntroMessage: "If you would like to support development financially, Buy Me a Coffee is the one place to do it.",
        supportIntroStarButton: "Star AltF4 on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover AltF4 and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The AltF4 Discord community is just getting started",
        discordIntroMessage: "The AltF4 community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        communityIntroFollowButton: "Follow @altf4 on X",
        homebrewOfficialIntroTitle: "Now in the official Homebrew catalog",
        homebrewOfficialIntroMessage: "AltF4 can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If AltF4’s icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen AltF4 from Applications or Spotlight: that rebuilds the icon and, if it’s still hidden, opens this window.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for AltF4 there, or set %@ to always show AltF4.",
        ...
        cleanerNotifDenied: "AltF4 notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag AltF4 to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn AltF4 on under Open at Login.",
        ...
        mouseAccelerationCaption: "Removes pointer acceleration for connected mice. Your previous setting returns when this is turned off or AltF4 quits.",

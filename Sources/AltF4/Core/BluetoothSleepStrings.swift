...
extension BluetoothSleepStrings {
    static let enUS = BluetoothSleepStrings(
        ...
        restoreCaption: "Only when AltF4 was the one that switched it off.",
    ...
    static let ptBR = BluetoothSleepStrings(
        ...
        restoreCaption: "Apenas quando foi o AltF4 que o desligou.",
    ...
    static let tr = BluetoothSleepStrings(
        ...
        restoreCaption: "Yalnızca kapatan AltF4 olduğunda.",
    ...
    static let ru = BluetoothSleepStrings(
        ...
        restoreCaption: "Только если его выключил сам AltF4.",
    ...
    static let es = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo cuando fue AltF4 quien lo apagó.",
    ...
    static let de = BluetoothSleepStrings(
        ...
        restoreCaption: "Nur wenn AltF4 es ausgeschaltet hat.",
    ...
    static let fr = BluetoothSleepStrings(
        ...
        restoreCaption: "Uniquement si c’est AltF4 qui l’a coupé.",
    ...
    static let it = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo quando è stato AltF4 a spegnerlo.",
    ...
    static let ja = BluetoothSleepStrings(
        ...
        restoreCaption: "AltF4が切った場合のみ戻します。",
    ...
    static let ko = BluetoothSleepStrings(
        ...
        restoreCaption: "AltF4가 껐을 때만 다시 켭니다.",
    ...
    static let zhHans = BluetoothSleepStrings(
        ...
        restoreCaption: "仅在蓝牙是由 AltF4 关闭时。",
    ...
    static let zhTW = BluetoothSleepStrings(
        ...
        restoreCaption: "僅在藍牙是由 AltF4 關閉時。",
    ...
    static let zhHK = BluetoothSleepStrings(
        ...
        restoreToggle: "Mac 喚醒時重新開啟藍牙",
        restoreCaption: "只在藍牙是由 AltF4 關閉時。",

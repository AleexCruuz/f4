...
enum DefaultsKey {
    ...
    // Set only while AltF4 owes a Bluetooth restore, so a Mac shut down
    ...
    static let screenshotHideAltF4Windows = "screenshotHideAltF4Windows"
...
enum KeepAwakeActiveIcon: String, CaseIterable, Identifiable {
    case altf4, coffee, eye, moon, light
    ...
    var menuBarDrop: CGFloat {
        ...
        case .altf4, .eye, .moon: return 0
        }
    }

    func title(_ strings: Strings) -> String {
        switch self {
        case .altf4: return strings.keepAwakeActiveIconAltF4
...
enum Defaults {
    ...
    static let registeredDefaults: [String: Any] = [
        ...
        DefaultsKey.keepAwakeActiveIcon: KeepAwakeActiveIcon.altf4.rawValue,
        ...
        DefaultsKey.clipboardAIEnabled: true,
        ...
        DefaultsKey.screenshotHideAltF4Windows: true,

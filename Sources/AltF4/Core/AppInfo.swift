...
enum AppInfo {
    static let name = "AltF4"
    /// AltF4 is a modified fork of Vorssaint, so both authors are credited.
    static let copyright = "© 2026 Vorssaint · © 2026 AltF4 contributors"
    ...
    /// True for the local "AltF4 (Developer)" build (bundle id ends in `.dev`).
    ...
    static var buildCommit: String? {
        Bundle.main.object(forInfoDictionaryKey: "AltF4BuildCommit") as? String
    }
}

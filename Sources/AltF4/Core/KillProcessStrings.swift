...
extension KillProcessFeatureStrings {
    static let enUS = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 needs administrator access to end “%@”."
    )
    ...
    static let ptBR = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "O AltF4 precisa de acesso de administrador para encerrar “%@”."
    )
    ...
    static let tr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4’in “%@” işlemini sonlandırması için yönetici erişimi gerekiyor."
    )
    ...
    static let ru = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 нужны права администратора, чтобы завершить «%@»."
    )
    ...
    static let es = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 necesita acceso de administrador para finalizar “%@”."
    )
    ...
    static let de = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 benötigt Administratorrechte, um „%@“ zu beenden."
    )
    ...
    static let fr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 a besoin d’un accès administrateur pour arrêter «\u{00A0}%@\u{00A0}»."
    )
    ...
    static let it = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 richiede l’accesso da amministratore per terminare “%@”."
    )
    ...
    static let zhHans = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 需要您的管理员密码才能结束“%@”。"
    )
    ...
    static let zhTW = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "AltF4 需要管理員權限才能結束「%@」。"
    )

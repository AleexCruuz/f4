...
final class ShelfService: ObservableObject {
    ...
    private let tempDir: URL = {
        let id = Bundle.main.bundleIdentifier ?? "com.altf4.utils"
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("AltF4Shelf", isDirectory: true)
    ...
    private static let persistQueue = DispatchQueue(label: "com.altf4.utils.shelf-persist",
                                                    qos: .utility)

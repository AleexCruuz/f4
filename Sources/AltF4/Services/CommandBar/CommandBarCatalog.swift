...
enum CommandBarCatalog {
    ...
    /// showing its own shortcut. This is how the bar reaches past AltF4
    ...
    /// runs, so one row serves both "gh" and "gh altf4".
    ...
    private static func keepOnShelf(_ text: String) {
        let board = NSPasteboard(name: NSPasteboard.Name("com.altf4.commandbar.selection"))
        board.clearContents()

...
final class AppVolumeMixer: ObservableObject {
    ...
    private let buildQueue = DispatchQueue(label: "com.altf4.utils.mixer", qos: .userInitiated)
    ...
    private let halQueue = DispatchQueue(label: "com.altf4.utils.mixer.hal", qos: .userInitiated)
    ...
    private static func outputDevices(defaultUID: String?) -> [MixerOutputDevice] {
        ...
        for deviceID in deviceIDs {
            ...
            let name = read(deviceID, kAudioObjectPropertyName, &nameRef)
                ? nameRef as String
                : uid
            guard name != "AltF4 Mixer" else { continue }
...
private final class TapGainEngine: GainEngine {
    ...
    init?(objects: [AudioObjectID], gain: Float, outputDeviceUID: String) {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "AltF4 Mixer",
    ...
    private static let rateQueue = DispatchQueue(label: "com.altf4.utils.mixer.rate",
                                                 qos: .userInitiated)
    ...
    private static let teardownQueue: OperationQueue = {
        ...
        queue.name = "com.altf4.utils.mixer.teardown"

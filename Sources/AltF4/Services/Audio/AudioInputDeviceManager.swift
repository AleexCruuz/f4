...
/// Keeps AltF4's preferred microphone in sync with macOS' global input.
...
final class AudioInputDeviceManager: ObservableObject {
    ...
    private let halQueue = DispatchQueue(label: "com.altf4.utils.audioinput.hal", qos: .userInitiated)

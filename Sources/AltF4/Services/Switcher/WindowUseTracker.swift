...
final class WindowUseTracker {
    ...
    @objc private func appActivated(_ note: Notification) {
        ...
        // self-activating on the way out; ranking it would put AltF4 ahead
        // of the app the user left. Every other activation of AltF4, the
    ...
    private func startWatcher() {
        let thread = lifecycleLock.withLock { () -> Thread? in
            ...
            thread.name = "AltF4 Window Focus"

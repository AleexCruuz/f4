...
final class RecorderCaptureEngine: NSObject {
    ...
    private let queue = DispatchQueue(label: "com.altf4.recorder.capture",
                                      qos: .userInitiated)
    ...
    /// Builds the filter and starts the stream. Existing ordinary AltF4
...
final class RecorderMicrophoneCapture: NSObject,
    ...
    private let queue = DispatchQueue(label: "com.altf4.recorder.microphone",
                                      qos: .userInitiated)

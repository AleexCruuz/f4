...
final class RecorderSystemAudioTap: @unchecked Sendable {
    ...
    private static let teardownQueue = DispatchQueue(label: "com.altf4.recorder.systemaudio.teardown",
                                                     qos: .utility)
    ...
    static func make() async -> RecorderSystemAudioTap? {
        ...
        let queue = DispatchQueue(label: "com.altf4.recorder.systemaudio",
                                  qos: .userInitiated)
    ...
    private init?(queue: DispatchQueue) {
        ...
        description.name = "AltF4 Recorder"
    ...
    private func buildPipeline() {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "AltF4 Recorder",

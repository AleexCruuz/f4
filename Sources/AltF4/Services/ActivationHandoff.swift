...
/// activation this app holds, and AltF4 (`LSUIElement`, non-activating
...
enum ActivationHandoff {
    ...
    /// Past that, an activation of AltF4 is the user opening one of its
    ...
    /// Whether the activation of AltF4 being reported right now is the one

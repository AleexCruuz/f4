...
final class AppUpdatesService: ObservableObject {
    ...
    private let workQueue = DispatchQueue(label: "com.altf4.appupdates", qos: .utility)
    ...
    private static func isOwnBundle(_ bundleID: String) -> Bool {
        bundleID == Bundle.main.bundleIdentifier || bundleID.hasPrefix("com.altf4")
    }

    private static let ownPackageTokens: Set<String> = ["altf4", "altf4@beta", "altf4-beta"]

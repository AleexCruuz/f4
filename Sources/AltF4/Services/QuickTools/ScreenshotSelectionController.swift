...
final class ScreenshotSelectionController {
    ...
    private var hideAltF4Windows: Bool
    ...
    init(freeze: Bool,
        ...
        self.hideAltF4Windows = hideAltF4Windows
        ...
        self.capturePolicy = ScreenshotSupport.UnifiedCapturePolicy(
            ...
            hideAltF4Windows: hideAltF4Windows,
            keepsContentWindowsOut: hideAltF4Windows
        ...
        if freeze {
            Task { @MainActor [weak self] in
                ...
                let images = await ScreenshotCaptureEngine.captureAllDisplays(
                    ...
                    hideAltF4Windows: self.hideAltF4Windows,
    ...
    private func screenCaptureToolDidChange() {
        if let activeTool {
            ...
            let nextPolicy = ScreenshotSupport.unifiedCapturePolicy(
                ...
                screenshotHideAltF4Windows: defaults.bool(
                    forKey: DefaultsKey.screenshotHideAltF4Windows))
    ...
    private func adoptCapturePolicy(_ policy: ScreenshotSupport.UnifiedCapturePolicy) {
        ...
        hideAltF4Windows = policy.hideAltF4Windows
    ...
    private func loadLiveLoupeImages() {
        let generation = sourceGeneration
        let hideWindows = hideAltF4Windows
        let excludedIDs = captureExcludedWindowIDs
        Task { @MainActor [weak self] in
            let images = await ScreenshotCaptureEngine.captureAllDisplays(
                includePointer: false,
                hideAltF4Windows: hideWindows,

...
final class ScreenshotService: ObservableObject {
    ...
    private var hideAltF4Windows: Bool {
        UserDefaults.standard.bool(forKey: DefaultsKey.screenshotHideAltF4Windows)
    }
    ...
    /// Ordinary windows somebody left on screen, which the "Hide AltF4
...
enum ScreenshotLastCaptureStore {
    private static let writeQueue = DispatchQueue(
        label: "com.altf4.utils.latest-screenshot",
        qos: .utility)
